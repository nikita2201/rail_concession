...
$erpnow=$_GET['erpid'];
    ...
    $sql = "SELECT * FROM form WHERE erp_id = '$erpnow' and status='approved'";
    $result = $conn->query($sql);
    if ($result->num_rows > 0) {
        // output data of each row
        while ($row = $result->fetch_assoc()) {
     ...
     <div class="container">
         ...
         <div class="form-container">
             <form action="" method="POST">
                 ...
                 <label for=" ">Address (as per admission form) </label><textarea name="address" rows="4" cols="40" wrap="soft" readonly> <?php echo $address ;?></textarea><br>
                 ...
                 <label for=" ">Vch no.</label><input type="text" value="<?php echo $vchno ;?>" readonly><br>

                 <CENTER class="buttons"><a href="admin/approv.php"><div class="go-back-but">Go Back</div></a></CENTER>
             </form>
         </div>
